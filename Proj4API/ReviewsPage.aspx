...
<body>
    <form id="form1" runat="server">
        <asp:ScriptManager ID="ScriptManagerReviewsPage" runat="server"></asp:ScriptManager>
        <asp:UpdatePanel ID="UpdatePanelReviewsPage" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="Form">
